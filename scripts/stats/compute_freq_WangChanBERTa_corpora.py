...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="compute_freq_WangChanBERTa_corpora",
        description="compute word frequencies of words in corpora used to pretrained WangChanBERTa",
    )
    ...
    with open(f'{args.output_dir}/frequency_stats_WangChanBERTa_corpora.csv', 'w') as f:
        writer = csv.writer(f)
