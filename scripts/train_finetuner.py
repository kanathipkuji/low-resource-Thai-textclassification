...
def main():
    ...
    # initialize models using the number of unique labels train_dataset. Since labels in train_dataset is stratified so that it includes all possible labels, there should be no problem.
